...
import "../../Pausable.sol";
import "../../interfaces/mono/IPool.sol";
import "../../interfaces/mono/IPoolConfig.sol";
import "../../auth/CallerList.sol";
import "../../utils/Constants.sol";

/// @title Holding pool share token
contract PoolShareToken is Constants, CallerList, ERC20, Shutdownable, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    
    IERC20 public immutable token;
    IPoolConfig public immutable poolConfig;
    ...
    constructor(
        ...
        token = IERC20(_token);
        poolConfig = IPoolConfig(_poolConfig);
    ...
    function depositWithPermit(
        ...
        IPool(address(token)).permit(_msgSender(), address(this), amount, deadline, v, r, s);
        _deposit(amount);
    }
    ...
    function withdrawByStrategy(uint256 shares) external virtual nonReentrant whenNotShutdown {
        require(isApproved(_msgSender()) == true, "Not a white listed address");
